...
\lstinputlisting{src/uk/ac/gla/confound/Solver.java}
\lstinputlisting{src/uk/ac/gla/confound/SolverMethods.java}
\subsubsection*{Backtrack Solver}
\lstinputlisting{src/uk/ac/gla/confound/BacktrackSolver.java}
